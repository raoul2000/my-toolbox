...
var createRowHTML = function(rootPath, cmpItem) {
  ...
  var relativePath = cmpItem.path;
  var absolutePath = cmpItem.path;
...
var renderCompareReport = function(data) {
    ...
    var tableBody = document.querySelector("#rdiff-result tbody");
    while(tableBody.firstChild) {
      tableBody.removeChild(tableBody.firstChild);
    }
    // create HTML
    var resultRowsHTML = data.output.map(function(item){
      return createRowHTML("/folder", item);
    }).join('\n');
